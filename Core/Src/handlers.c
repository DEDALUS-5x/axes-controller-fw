    ...
    if (htim -> Instance == TIM6) {
        ...
        */
        ...
        if (machine_state == HOMING || machine_state == RUN) {
              ...
              stepper_loop(&axis_A1, &htim15, TIM_CHANNEL_1, DIR_P1_GPIO_Port, DIR_P1_Pin, 20.0f, 1.5f, 0.15f, dt);
              stepper_loop(&axis_A2, &htim16, TIM_CHANNEL_1, DIR_P2_GPIO_Port, DIR_P2_Pin, 20.0f, 1.5f, 0.15f, dt);
              stepper_loop(&axis_C, &htim8, TIM_CHANNEL_2, DIR_Y_GPIO_Port, DIR_Y_Pin, 0.2, 0.01f, 0.5f, dt);
