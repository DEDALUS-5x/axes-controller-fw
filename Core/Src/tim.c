...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    PB7     ------> TIM4_CH2
    */
    GPIO_InitStruct.Pin = ENC_A_PWM_Pin|ENC_Z_PWM_Pin;
    ...
    /* TIM4_CH2 Init */
    hdma_tim4_ch2.Instance = DMA2_Stream2;
...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    */
    GPIO_InitStruct.Pin = MX_A_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(MX_A_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = MX_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(MX_B_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PA7     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = MY2_A_Pin|MY2_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM5_MspInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    GPIO_InitStruct.Pin = MY1_A_Pin|MY1_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM23_MspInit 0 */
    ...
    PG13     ------> TIM23_CH2
    */
    GPIO_InitStruct.Pin = ENC_C_PWM_Pin|ENC_F_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    hdma_tim23_ch1.Init.Priority = DMA_PRIORITY_LOW;
    ...
    __HAL_LINKDMA(tim_icHandle,hdma[TIM_DMA_ID_CC1],hdma_tim23_ch1);

    /* TIM23_CH2 Init */
    hdma_tim23_ch2.Instance = DMA2_Stream0;
    hdma_tim23_ch2.Init.Request = DMA_REQUEST_TIM23_CH2;
    hdma_tim23_ch2.Init.Direction = DMA_PERIPH_TO_MEMORY;
    ...
    hdma_tim23_ch2.Init.Priority = DMA_PRIORITY_LOW;
    ...
    __HAL_LINKDMA(tim_icHandle,hdma[TIM_DMA_ID_CC2],hdma_tim23_ch2);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE14     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = MX_IN1_Pin|MX_IN2_Pin|MY1_IN1_Pin|MY1_IN2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = STEP_Z1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
    HAL_GPIO_Init(STEP_Z1_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PC7     ------> TIM8_CH2
    */
    GPIO_InitStruct.Pin = MY2_IN1_Pin|MY2_IN2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM15_MspPostInit 0 */
    ...
    PC12     ------> TIM15_CH1
    */
    GPIO_InitStruct.Pin = STEP_P1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM15;
    HAL_GPIO_Init(STEP_P1_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB9     ------> TIM4_CH4
    */
    HAL_GPIO_DeInit(H_PWM_GPIO_Port, H_PWM_Pin);

    HAL_GPIO_DeInit(GPIOB, ENC_A_PWM_Pin|ENC_Z_PWM_Pin|STEP_Z1_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3(JTDO/TRACESWO)     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(MX_A_GPIO_Port, MX_A_Pin);

    HAL_GPIO_DeInit(MX_B_GPIO_Port, MX_B_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOA, MY2_A_Pin|MY2_B_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOA, MY1_A_Pin|MY1_B_Pin);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM23_MspDeInit 0 */
    ...
    PG13     ------> TIM23_CH2
    */
    HAL_GPIO_DeInit(GPIOG, ENC_C_PWM_Pin|ENC_F_PWM_Pin);
